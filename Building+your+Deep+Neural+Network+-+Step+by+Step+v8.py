...
def L_model_forward(X, parameters):
    ...
    for l in range(1, L):
        ...
        print("W.shape ", str(parameters['W'+ str(l)].shape))
        print("B.shape ", str(parameters['b'+ str(l)].shape))

        ### END CODE HERE ###
    
    # Implement LINEAR -> SIGMOID. Add "cache" to the "caches" list.
    ### START CODE HERE ### (≈ 2 lines of code)
    print("A.shape ", str(A.shape), L)
...
def L_model_backward(AL, Y, caches):
    ...
    grads["dA" + str(L - 1)], grads["dWL"], grads["dbL"] = dA_prev, dW, db
    ### END CODE HERE ###
